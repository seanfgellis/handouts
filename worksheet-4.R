...
spread(df2, key=species, value=n, fill='OMG We are missing data!')
...
animals_kangaroo_rat <- filter(animals, species_id=='RO')

animals_kangaroo_rat <- select(animals_kangaroo_rat, id, sex, weight)
